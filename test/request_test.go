...
func ExampleNewRequest_Error() {
	...
	//Output:
	//test: NewRequest(file://[cwd]/resource/get-request123.txt) -> [status:I/O Failure [open C:\Users\markb\GitHub\common\test\resource\get-request123.txt: The system cannot find the file specified.]][req:false]
