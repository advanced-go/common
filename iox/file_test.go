...
func Example_FileName() {
	...
	s = "file:///c:/Users/markb/GitHub/stdlib/iox/ioxtest/test-response.txt"
	name = FileName(s)
	fmt.Printf("test: FileName(%v) -> [type:%v] [url:%v]\n", s, reflect.TypeOf(s), name)
	...
	//test: FileName(file://[cwd]/ioxtest/test-response.txt) -> [type:string] [url:C:\Users\markb\GitHub\common\iox\ioxtest\test-response.txt]
	//test: FileName(file://[cwd]/ioxtest/test-response.txt) -> [type:*url.URL] [url:C:\Users\markb\GitHub\common\iox\ioxtest\test-response.txt]
	//test: FileName(file:///c:/Users/markb/GitHub/stdlib/iox/ioxtest/test-response.txt) -> [type:string] [url:c:\Users\markb\GitHub\stdlib\iox\ioxtest\test-response.txt]
	//test: FileName(file:///c:/Users/markb/GitHub/stdlib/iox/ioxtest/test-response.txt) -> [type:*url.URL] [url:c:\Users\markb\GitHub\stdlib\iox\ioxtest\test-response.txt]
...
func Example_OSReadFile() {
	...
	//test: os.ReadFile(file:///c:/Users/markb/GitHub/stdlib/iox/ioxtest/test-response.txt) -> [err:open c:\Users\markb\GitHub\stdlib\iox\ioxtest\test-response.txt: The system cannot find the path specified.] [buf:0]
...
func ExampleReadFile() {
	...
	//Output:
	//test: ReadFile(file://[cwd]/ioxtest/status-504.json) -> [type:string] [buf:82] [status:OK]
	//test: ReadFile(file://[cwd]/ioxtest/address1.json) -> [type:string] [buf:68] [status:OK]
	//test: ReadFile(file://[cwd]/ioxtest/status-504.json) -> [type:*url.URL] [buf:82] [status:OK]
	//test: ReadFile(file://[cwd]/ioxtest/address1.json) -> [type:*url.URL] [buf:68] [status:OK]
...
func ExampleReadFileWithEncoding() {
	...
	//Output:
	//test: ReadFileWithEncoding("file://[cwd]/ioxtest/hello-world.gz",nil) -> [buf:Hello World!!] [status:OK]
	//test: ReadFileWithEncoding("file://[cwd]/ioxtest/hello-world.gz",h) -> [buf:Hello World!!] [status:OK]
	//test: ReadFileWithEncoding("file://[cwd]/ioxtest/hello-world.txt",nil) -> [buf:Hello World!!] [status:OK]
...
func ExampleReadFileEmbedded() {
	...
	//Output:
	//test: ReadFileEmbedded("file:///f:/ioxtest/hello-world.txt") -> [buf:] [status:I/O Failure [open ioxtest/hello-world.txt: file does not exist]]
	//test: ReadFileEmbedded("file:///f:/ioxtest/invalid-file-name") -> [buf:] [status:I/O Failure [open ioxtest/invalid-file-name: file does not exist]]
	//test: ReadFileEmbedded("file:///f:/ioxtest/hello-world.txt") -> [buf:Hello World!!] [status:OK]
