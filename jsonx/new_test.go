...
const (
	...
	status504       = "file://[cwd]/jsonxtest/status-504.json"
)
...
func ExampleNew_String_Error() {
	...
	//test: New(file://[cwd]/jsonxtest/address.txt) -> [status:I/O Failure [open C:\Users\markb\GitHub\common\jsonx\jsonxtest\address.txt: The system cannot find the file specified.]]
...
func ExampleNew_String_Status() {
	...
	//test: New(file://[cwd]/jsonxtest/status-504.jsonx) -> [bytes:[]] [status:Timeout [error 1]]
...
func ExampleNew_String_URI() {
	...
	//Output:
	//test: New(file://[cwd]/jsonxtest/address1.json) -> [addr:{frisco texas 75034}] [status:OK]
...
func ExampleNew_URL_Status() {
	...
	//Output:
	//test: New(file://[cwd]/jsonxtest/status-504.json) -> [addr:{  }] [status:Timeout [error 1]]
...
func ExampleNew_Bytes() {
	...
	//Output:
	//test: New(file://[cwd]/jsonxtest/address2.json) -> [addr:{vinton iowa 52349}] [status:OK]
	//test: New(file://[cwd]/jsonxtest/address2.gz) -> [addr:{vinton iowa 52349}] [status:OK]
...
func ExampleNew_ReadCloser() {
	...
	//Output:
	//test: New(file://[cwd]/jsonxtest/address3.json) -> [addr:{forest city iowa 50436}] [status:OK]
